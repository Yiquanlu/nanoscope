...
rule generate_saturation_curves:
    ...
    params:
        script=workflow.basedir + '/scripts/saturation_curves.py',
        output_dir=lambda wildcards: os.getcwd(),
        modality_barcode=lambda wildcards: f"{wildcards.modality}_{wildcards.barcode}",
    ...
    shell:
        ...
        python3 {params.script} --output_dir {params.output_dir} \
            ...
            --modality_barcode {params.modality_barcode} \
